...
?>
<form
	 name="commentaire"  action="commentaire_post.php"  method='POST'  >
	  <table width="400" >
            <tr>
                  <td> Auteur : </td></tr>
                 <tr> <td> <input type="text" name="auteur" size="40"  /></td>
              </tr>
              <tr> <td> Commentaire : </td></tr>
              <tr><td width="200"><textarea name="commentaire"   rows="20"  cols="50"></textarea></td>
          </tr>
               <tr> <td colspan="2"> 
